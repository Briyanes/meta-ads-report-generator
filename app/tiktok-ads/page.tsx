      ...
      <main className="responsive-container" style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <i className="bi bi-music-note-beamed" style={{ fontSize: '48px', color: '#ec4899' }}></i>
          </div>
          <h2 style={{
            fontSize: '36px',
            fontWeight: 'bold',
          ...
          <p style={{
            ...
            We&apos;re working hard to bring you TikTok Ads reporting capabilities. Stay tuned for updates!
          </p>
          <div style={{
          ...
          <div style={{
            ...
            <ul style={{
              ...
              {[
                'Comprehensive TikTok Ads performance analytics',
                ...
                <li key={idx} style={{
                  ...
                  <i className="bi bi-check-circle" style={{ color: '#ec4899', fontSize: '18px' }}></i>
